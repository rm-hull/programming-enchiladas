...
demo.rm_hull_7778650.core.filename = (function (){var G__24983 = demo.rm_hull_7778650.core.texture_uri((function (){var G__24984 = new cljs.core.Keyword(null,"texture","texture",-266291651);
var G__24985 = demo.rm_hull_7778650.core.random_texture();
return (enchilada.value_of.cljs$core$IFn$_invoke$arity$2 ? enchilada.value_of.cljs$core$IFn$_invoke$arity$2(G__24984,G__24985) : enchilada.value_of.call(null,G__24984,G__24985));
})());
return (enchilada.proxy_request.cljs$core$IFn$_invoke$arity$1 ? enchilada.proxy_request.cljs$core$IFn$_invoke$arity$1(G__24983) : enchilada.proxy_request.call(null,G__24983));
})();
demo.rm_hull_7778650.core.globe = (new PhiloGL.O3D.Sphere((function (){var G__24986 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"nlat","nlat",541374177),(30),new cljs.core.Keyword(null,"nlong","nlong",-2027803312),(30),new cljs.core.Keyword(null,"radius","radius",-2073122258),(2),new cljs.core.Keyword(null,"textures","textures",560681081),demo.rm_hull_7778650.core.filename], null);
return (enchilada.to_js.cljs$core$IFn$_invoke$arity$1 ? enchilada.to_js.cljs$core$IFn$_invoke$arity$1(G__24986) : enchilada.to_js.call(null,G__24986));
})()));
...
var current__24870__auto___25134 = (demo.rm_hull_7778650.core.globe.rotation.y["x"]);
(demo.rm_hull_7778650.core.globe.rotation.y["x"] = (current__24870__auto___25134 + ((delta_pos.cljs$core$IFn$_invoke$arity$1 ? delta_pos.cljs$core$IFn$_invoke$arity$1((0)) : delta_pos.call(null,(0))) / (100))));

var current__24870__auto___25138 = (demo.rm_hull_7778650.core.globe.rotation.x["x"]);
(demo.rm_hull_7778650.core.globe.rotation.x["x"] = (current__24870__auto___25138 + ((delta_pos.cljs$core$IFn$_invoke$arity$1 ? delta_pos.cljs$core$IFn$_invoke$arity$1((1)) : delta_pos.call(null,(1))) / (100))));
...
var current__24870__auto___25143 = (cljs.core.deref(demo.rm_hull_7778650.core.cam_ob).position.z["x"]);
(cljs.core.deref(demo.rm_hull_7778650.core.cam_ob).position.z["x"] = (current__24870__auto___25143 + e.wheel));
